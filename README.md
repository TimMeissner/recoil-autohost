...
Autohost now supports both environment-based config and JSON config files.
...
To see all options and validation rules take a look at [`src/config.ts`](./src/config.ts)
